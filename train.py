...
#         sentences_src = segregate_to_sentence_level(ds_raw[i]['translation'][config['lang_src']])
#         sentences_tgt = segregate_to_sentence_level(ds_raw[i]['translation'][config['lang_tgt']])
    ...
    for epoch in range(initial_epoch, config.get_config()['num_epochs']):
        ...
        for batch in batch_iterator:
            ...
            if "[SEP]" in batch['tgt_text']:
                ...
                # Use the entire proj_output if the [SEP] token is not found or is at the end
